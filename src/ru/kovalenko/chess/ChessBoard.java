    ...
    public boolean moveToPosition(int startLine, int startColumn, int endLine, int endColumn) {
        if (checkPos(startLine) && checkPos(startColumn)) {
            ...
            if (board[startLine][startColumn].canMoveToPosition(this, startLine, startColumn, endLine, endColumn)) {
                ...
                // если ладья или король ходили присвоить им false чтобы нельзя было сделать рокировку
                ChessPiece rookOrKing = board[endLine][endColumn];
                if (rookOrKing instanceof Rook || rookOrKing instanceof King) rookOrKing.check = false;
                return true;
            } else return false;
        } else return false;
    }
        ...
        if (nowPlayer.equals("White")) {
            ...
            if (board[0][0].getSymbol().equals("R") && board[0][4].getSymbol().equals("K") &&  // check that King and Rook
                ...
                if (board[0][0].getColor().equals("White") && board[0][4].getColor().equals("White") &&
                        ...
                        !new King("White").isUnderAttack(this, 0, 4) &&  // check this position not in under attack
            ...
            if (board[7][0].getSymbol().equals("R") && board[7][4].getSymbol().equals("K") &&  // check that King and Rook
                ...
                if (board[7][0].getColor().equals("Black") && board[7][4].getColor().equals("Black") &&
                        ...
                        !new King("Black").isUnderAttack(this, 7, 4) &&  // check this position not in under attack
